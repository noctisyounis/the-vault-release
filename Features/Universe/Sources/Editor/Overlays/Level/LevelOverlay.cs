...
namespace Universe.Overlays
{
	...
	public class LevelOverlay : ToolbarOverlay
	{
		...
		private VisualElement BuildEnvironmentBlock()
		{
			...
			_toggleBlock	= new(_playerPrefLevel, BLOCK_MESH, "Toggle the block mesh situations");
			_toggleArt		= new(_playerPrefLevel, ART, "Toggle the art situations"); 
		...
		private VisualElement BuildPlaymodeSceneBlock()
		{
			...
			_selectLevel	= new("Play:", _playerPrefLevel);
			_selectTask		= new("On:");
		...
		private static string _playerPrefLevel = "EditorLevelPath";
